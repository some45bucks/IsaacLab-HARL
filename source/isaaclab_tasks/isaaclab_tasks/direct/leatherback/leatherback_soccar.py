...
@configclass
class LeatherbackSoccerEnvCfg(DirectMARLEnvCfg):
    decimation = 4
...
class LeatherbackSoccerEnv(DirectMARLEnv):
    cfg: LeatherbackSoccerEnvCfg

    def __init__(self, cfg: LeatherbackSoccerEnvCfg, render_mode: str | None = None, headless: bool | None = None, **kwargs):
