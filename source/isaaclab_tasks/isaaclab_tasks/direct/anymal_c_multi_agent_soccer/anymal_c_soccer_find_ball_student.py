...
@configclass
class AnymalCSoccerCameraCfg(DirectMARLEnvCfg):
    # env
    ...
    walking_policy_dir = "/home/zacmaughan/IsaacLab-HARL-v2/results/isaaclab/Flat_AnymalC_Walk_Soccer_Direct-v0/happo/harl_anymal_c_walk_soccer/Training_Camera_Model/best_model/actor_agent0.pt"
