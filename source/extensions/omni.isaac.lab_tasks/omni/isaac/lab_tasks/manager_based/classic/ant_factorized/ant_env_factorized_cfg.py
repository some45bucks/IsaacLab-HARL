...
from omni.isaac.lab.envs import ManagerBasedMARLEnvCfg
...
class ActionsCfg:
    ...
    agentFR = mdp.JointEffortActionCfg(asset_name="robot", joint_names=["^front_right_.*$"], scale=7.5)
    agentFL = mdp.JointEffortActionCfg(asset_name="robot", joint_names=["^front_left_.*$"], scale=7.5)
    agentHR = mdp.JointEffortActionCfg(asset_name="robot", joint_names=["^right_back_.*$"], scale=7.5)
    agentHL = mdp.JointEffortActionCfg(asset_name="robot", joint_names=["^left_back_.*$"], scale=7.5)
...
class ObservationsCfg:
    ...
    # observation groups
    agentFR: PolicyCfg = PolicyCfg()
    agentFL: PolicyCfg = PolicyCfg()
    agentHR: PolicyCfg = PolicyCfg()
    agentHL: PolicyCfg = PolicyCfg()
...
@configclass
class AntEnvFactorizedCfg(ManagerBasedMARLEnvCfg):
